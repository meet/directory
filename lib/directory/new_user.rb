module Directory
  ...
  class NewUser
    ...
    validate do |user|
      ...
      errors.add(:first_name, 'should not end in whitespace') if first_name =~ /\s\Z/
      errors.add(:first_name, 'should not start with whitespace') if first_name =~ /\A\s/
      errors.add(:last_name, 'should not contain whitespace') if last_name =~ /\s\Z/
      errors.add(:last_name, 'should not start with whitespace') if last_name =~ /\A\s/
    end
